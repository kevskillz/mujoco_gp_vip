...
HIDDEN_PI = [128, 128, 64]  # Increased number of layers and neurons
HIDDEN_VF = [128, 128, 64]  # Increased number of layers and neurons
ACTIVATION = nn.ReLU  # ReLU activation function for hidden layers
ACTIVATION_OUTPUT = nn.Tanh  # Tanh activation function for output layer
