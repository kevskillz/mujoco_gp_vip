...
def get_hidden_layers_pi():
    """Returns the hidden layers for pi."""
    return HIDDEN_PI

def get_hidden_layers_vf():
    """Returns the hidden layers for vf."""
    return HIDDEN_VF
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(
            ...
            **kwargs,
            ...
            net_arch=dict(
                pi=get_hidden_layers_pi(),
                vf=get_hidden_layers_vf()
            ),
        )

### Get Policy Kwargs
def get_policy_kwargs():
    """Returns the policy kwargs."""
    return {
        "policy_class": GenePolicy
    }
