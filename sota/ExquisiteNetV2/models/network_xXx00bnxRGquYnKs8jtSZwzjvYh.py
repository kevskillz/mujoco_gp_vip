...
def get_ppo_kwargs():
    return {
        "n_steps": 2048,  # Increased number of steps for better exploration
        ...
        "gae_lambda": 0.95,  # Increased lambda for better generalization
        "clip_range": 0.2,  # Decreased clip range for better stability
        "n_epochs": 10,  # Increased number of epochs for better convergence
    }
# --OPTION--
